...
public class FuncionarioController {
	...
	@ApiResponses(value = {
	@ApiResponse(code = 200, message = "Dependentes listados com sucesso"),
	@ApiResponse(code = 401, message = "Erro de autenticação"),
	@ApiResponse(code = 403, message = "Você não tem permissão para acessar o recurso"),
	@ApiResponse(code = 404, message = "Recurso Indisponivel"),
	@ApiResponse(code = 500, message = "Erros interno do servidor"),
	...
	public ResponseEntity<Funcionario> atualizar(@PathVariable Long id, @Valid @RequestBody Funcionario funcionario) throws DependenteException{
	...
	/*@GetMapping("/folhapagamento")
	public ResponseEntity<List<FuncionarioMostrarDTO>> folhaPagamento() {
		List<FuncionarioMostrarDTO> funcionarioDTOs = funcionarioService.listar();
