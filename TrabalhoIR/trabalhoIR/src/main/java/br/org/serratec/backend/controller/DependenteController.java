...
public class DependenteController {
	...
	@ApiResponses(value = {
	@ApiResponse(code = 201, message = "Dependente cadastrado com sucesso"),
	...
	@ApiResponses(value = {
	@ApiResponse(code = 200, message = "Dependente listado com sucesso"),
	@ApiResponse(code = 401, message = "Erro de autenticação"),
	@ApiResponse(code = 403, message = "Você não tem permissão para acessar o recurso"),
	@ApiResponse(code = 404, message = "Recurso Indisponivel"),
	@ApiResponse(code = 500, message = "Erros interno do servidor"),
	...
	@ApiResponses(value = {
	@ApiResponse(code = 200, message = "Veiculos listados com sucesso"),
	@ApiResponse(code = 401, message = "Erro de autenticação"),
	@ApiResponse(code = 403, message = "Você não tem permissão para acessar o recurso"),
	@ApiResponse(code = 404, message = "Recurso Indisponivel"),
	@ApiResponse(code = 500, message = "Erros interno do servidor"),
	...
	@ApiResponses(value = {
	@ApiResponse(code = 200, message = "Dependente atualizado com sucesso"),
	...
	@ApiResponses(value = {
	@ApiResponse(code = 200, message = "Dependente deletado com sucesso"),
